...
static const MemMapEntry base_memmap[] = {
    ...
    [VIRT_DMA_PL080] =          { 0x09011000, 0x00001000 }, /* Add PL080 support for virt platform */
    [VIRT_DMA_PL330] =          { 0x09012000, 0x00001000 }, /* Add PL080 support for virt platform */
...
static const int a15irqmap[] = {
    ...
    [VIRT_DMA_PL080] = 212, /* Add PL080 support for virt platform */
};
...
static void create_pl080_dma(VirtMachineState *vms)
{
    int i;
    char *nodename;
    hwaddr base = vms->memmap[VIRT_DMA_PL080].base;
    hwaddr size = vms->memmap[VIRT_DMA_PL080].size;
    int irq = vms->irqmap[VIRT_DMA_PL080];
...
static void virt_machine_class_init(ObjectClass *oc, void *data)
{
    ...
    machine_class_allow_dynamic_sysbus_dev(mc, TYPE_TZC400);
#ifdef CONFIG_TPM
